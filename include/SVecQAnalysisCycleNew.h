#if !defined(SVecQAnalysisCycleNew_H) && !defined(__CINT__)
#define SVecQAnalysisCycleNew_H

#include "SFrameTools/include/AnalysisModule.h"
#include <memory>

/**
 *   @short SVecQAnalysis of an analysis cycle, new version using AnalysisModule
 */
class SVecQAnalysisCycleNew : public AnalysisModule {
public:
