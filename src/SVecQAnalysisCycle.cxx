// $Id: SVecQAnalysisCycle.cxx,v 1.10 2012/12/07 14:21:51 peiffer Exp $
...
ClassImp( SVecQAnalysisCycle );

SVecQAnalysisCycle::SVecQAnalysisCycle()
   : AnalysisCycle() {
...
void SVecQAnalysisCycle::BeginCycle() throw( SError ) 
{
...
void SVecQAnalysisCycle::EndCycle() throw( SError ) 
{
...
void SVecQAnalysisCycle::BeginInputData( const SInputData& id ) throw( SError ) 
{
  ...
  RegisterHistCollection( new SVecQAnalysisHists("NoCuts") );
  RegisterHistCollection( new HypothesisHists("Chi2_NoCuts", m_chi2discr ) );

  //histograms with and without b tagging
  RegisterHistCollection( new SVecQAnalysisHists("BTag") );
  RegisterHistCollection( new SVecQAnalysisHists("NoBTag") );
  ...
  RegisterHistCollection( new SVecQAnalysisHists("TopSel") );
...
void SVecQAnalysisCycle::EndInputData( const SInputData& id ) throw( SError ) 
{
  AnalysisCycle::EndInputData( id );
}

void SVecQAnalysisCycle::BeginInputFile( const SInputData& id ) throw( SError ) 
{
...
void SVecQAnalysisCycle::ExecuteEvent( const SInputData& id, Double_t weight) throw( SError ) 
{
  ...
  // all thse BaseHists* vairables private member variables of SVecQAnalysisCycle and
