...
SVecQAnalysisHists::SVecQAnalysisHists(const char* name) : BaseHists(name)
{
  // named default constructor
   
}

SVecQAnalysisHists::~SVecQAnalysisHists(){
}

void SVecQAnalysisHists::Init()
{
...
void SVecQAnalysisHists::Finish()
{
